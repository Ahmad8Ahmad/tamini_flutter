...
/// parameter, which is the standard handshake for Django Channels. Set
/// [wssBaseUrl] to match the backend's WebSocket endpoint.
class OrderSocketService {
  static const String wssBaseUrl = 'wss://tamini.onrender.com/ws/orders/';

  static const List<int> _retryDelays = [1, 2, 4, 8, 15, 30];

  final Future<String?> Function() getToken;

  OrderSocketService({required this.getToken});
  ...
  Future<void> connect() async {
    ...
    try {
      ...
      _attempts = 0;
      debugPrint('OrderSocketService: connected to $wssBaseUrl');
